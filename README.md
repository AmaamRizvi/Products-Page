...
### Weblink: [Live Website](https://products-page-vert.vercel.app/)
...
1. Clone the repository: `git clone https://github.com/AmaamRizvi/Products-Page`
2. Navigate to the project directory: `cd product-page`
